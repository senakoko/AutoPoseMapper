...
class BigVariationalCE(tf.keras.Model):
    """
    ...
    def _model(self):
        ...
        dense = k.layers.Dense(512, activation='selu')(flat)
        ...
        batch_norm = k.layers.BatchNormalization()(dense)
        drop = k.layers.Dropout(0.2)(batch_norm)
        dense = k.layers.Dense(64, activation='selu')(drop)
        batch_norm = k.layers.BatchNormalization()(dense)
        drop = k.layers.Dropout(0.2)(batch_norm)
        dense = k.layers.Dense(32, activation='selu')(drop)
        ...
        dense = k.layers.Dense(32, activation='selu')(dec_inputs)
        batch_norm = k.layers.BatchNormalization()(dense)
        drop = k.layers.Dropout(0.2)(batch_norm)
        dense = k.layers.Dense(64, activation='selu')(drop)
        batch_norm = k.layers.BatchNormalization()(dense)
