...
def fix_bad_area(file=None, destination_path=None, tracker='CSI_Area_filtered'):
    """
    ...
    new_name = file_p.stem[:file_p.stem.find('_CSI')] + f'_{tracker}.h5'
    ...
    col = pd.MultiIndex.from_product([['CSI_Tracker'], individuals, bodyparts, ['x', 'y']],
